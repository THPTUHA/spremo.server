...
exports.default = (router) => {
    router.post("/update", (0, multer_1.default)({}).fields([]), passport_1.default.authenticate('jwt', { session: false }), (0, helper_1.wrapAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const user = req.user;
        if (!user) {
        ...
        try {
            const tag = (0, helper_1.getEmotion)(status);
            if (!tag) {
                return res.status(200).send(new BaseError_1.default("Emotion damage!", BaseError_1.default.Code.ERROR).release());
            }
            user.emotion_id = status;
            user.emotion_last_update = (0, helper_1.time)();
