...
exports.default = (router) => {
    router.post("/profile", (0, multer_1.default)({}).fields([]), passport_1.default.authenticate('jwt', { session: false }), (0, helper_1.wrapAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            if (req.user) {
                const user = req.user;
                user.last_login = (0, helper_1.time)();
