...
exports.default = (router) => {
    router.post("/select", (0, multer_1.default)({}).fields([]), passport_1.default.authenticate('jwt', { session: false }), (0, helper_1.wrapAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const { id } = req.body;
            ...
            if (blog.status != Constants_1.PUBLIC) {
                return res.status(200).send(new BaseError_1.default("Blog is'nt public!", BaseError_1.default.Code.ERROR).release());
            }
            blog.selected = Constants_1.SELECTED;
            blog.selected_since = (0, helper_1.time)();
