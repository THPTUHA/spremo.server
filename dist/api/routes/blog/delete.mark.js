...
exports.default = (router) => {
    router.post("/delete.mark", (0, multer_1.default)({}).fields([]), passport_1.default.authenticate('jwt', { session: false }), (0, helper_1.wrapAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const user = req.user;
        if (!user) {
        ...
        try {
            if (id) {
                ...
                yield user.editBlogSaved({ blog_id: (0, helper_1.castToNumber)(id), is_delete: true });
...
//# sourceMappingURL=delete.mark.js.map